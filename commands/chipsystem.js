...
function getSettings() {
    try {
        ...
        return {
            ownerNumber: '8801787638926',
            botOwner: '𝐗𝐀𝐅𝐒𝐀𝐍-𝐔𝐋𝐓𝐑𝐀'
        };
    }
}
...
async function addChipsCommand(sock, chatId, message, args) {
    try {
        ...
        if (args.length < 3) {
            await sock.sendMessage(chatId, { 
                text: '🔐 *ADD CHIPS TO USER*\n\nUsage:\n`.addchips [password] [user-number] [amount]`\n\nExample:\n`.addchips admin123 8801787638926 5000`\n\nThis will add 5,000 chips to user 8801787638926' 
            }, { quoted: message });
            return;
        }
