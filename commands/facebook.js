...
async function facebookCommand(sock, chatId, message) {
    try {
        ...
        try {
            const caption = title ? `*DOWNLOADED BY 𝐗𝐀𝐅𝐒𝐀𝐍-𝐔𝐋𝐓𝐑𝐀*\n\n📝 Title: ${title}` : "*DOWNLOADED BY 𝐗𝐀𝐅𝐒𝐀𝐍-𝐔𝐋𝐓𝐑𝐀*";
            ...
            try {
                ...
                // Send the video
                const caption = title ? `*DOWNLOADED BY 𝗚𝗔𝗡𝗚 𝗛𝗔𝗖𝗞𝗘𝗥*\n\n📝 Title: ${title}` : "*DOWNLOADED BY 𝗚𝗔𝗡𝗚 𝗛𝗔𝗖𝗞𝗘𝗥*";
