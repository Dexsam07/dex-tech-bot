...
async function textmakerCommand(sock, chatId, message, q, type) {
    try {
        ...
        switch (type) {
            case 'metallic':
                 usageErrorText = "Example: .metallic Shyam Choudhari";
                break              
            case 'ice':
                usageErrorText = "Example: .ice Shyam Choudhari";
                break;
            case 'snow':
                usageErrorText = "Example: .snow Shyam Choudhari";
                break;
            case 'impressive':
                usageErrorText = "Example: .impressive Shyam Choudhari";
                break;
            case 'matrix':
                usageErrorText = "Example: .matrix Shyam Choudhari";
                break;
            case 'light':
                usageErrorText = "Example: .light Shyam Choudhari";
                break;
            case 'neon':
                usageErrorText = "Example: .neon Shyam Choudhari";
                break;
            case 'devil':
                usageErrorText = "Example: .devil Shyam Choudhari";
                break;
            case 'purple':
                usageErrorText = "Example: .purple Shyam Choudhari";
                break;
            case 'thunder':
        ...
        try {
            ...
            await sock.sendMessage(chatId, {
                ...
                caption: "*GENERATED BY DEX-TECH-BOT*"
            });
            await sock.sendMessage(chatId, { react: { text: "✅", key: message.key } });
        } catch (error) {
