    ...
    try {
        ...
        if (replyMessage) {
            ...
            if (replyMessage.imageMessage) {
                ...
                messageContent = {
                    image: { url: filePath },
                    caption: messageText || replyMessage.imageMessage.caption || '*Copyright 𝐃𝐄𝐗 𝐓𝐄𝐂𝐇 𝐁𝐎𝐓 2026*',
            ...
            // Handle video messages
                ...
                messageContent = {
                    video: { url: filePath },
                    caption: messageText || replyMessage.videoMessage.caption || '*Copyright 𝐃𝐄𝐗 𝐓𝐄𝐂𝐇 𝐁𝐎𝐓 2026*',
                    mentions: mentionedJidList
                };
            }
            ...
            // Handle document messages
                ...
                messageContent = {
                    ...
                    caption: messageText || '*Copyright 𝐃𝐄𝐗 𝐓𝐄𝐂𝐇 𝐁𝐎𝐓 2026*',
                    mentions: mentionedJidList
                };
            }
