...
async function hideTagCommand(sock, chatId, senderId, messageText, replyMessage, message) {
    ...
    if (replyMessage) {
        ...
        if (replyMessage.imageMessage) {
            ...
            content = { image: { url: filePath }, caption: messageText || replyMessage.imageMessage.caption || '*Copyright DEX SHYAM TECH 2026*', mentions: nonAdmins };
        } else if (replyMessage.videoMessage) {
            const filePath = await downloadMediaMessage(replyMessage.videoMessage, 'video');
            content = { video: { url: filePath }, caption: messageText || replyMessage.videoMessage.caption || '*Copyright DEX SHYAM TECH 2026*', mentions: nonAdmins };
            ...
            content = { document: { url: filePath }, fileName: replyMessage.documentMessage.fileName, caption: messageText || '*Copyright DEX SHYAM TECH 2026*', mentions: nonAdmins };
        }
