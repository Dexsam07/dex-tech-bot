...
async function handleWelcome(sock, chatId, message, match) {
    try {
        ...
        if (lowerCommand === 'on') {
            ...
            await addWelcome(chatId, true, '╭─❖ 🌸 Welcome 🌸 ❖─╮👤 Hey {user} 🎊 A new member has joined the squad! Member:{count}📌 Follow the group rules 💬 Chat respectfully 🤝 Make friends and enjoy 💬 Chat respectfully ✨ May your stay be filled with fun, laughter, and good vibes!💖 Enjoy your time with us! {group}👩‍👩‍👧‍👧╰─❖ ❤️ Stay Awesome ❤️ ❖─╯');
            await sock.sendMessage(chatId, { 
...
async function handleGoodbye(sock, chatId, message, match) {
    try {
        ...
        if (lower === 'on') {
            ...
            await addGoodbye(chatId, true, 'Goodbye {user} Hawwar pola choila gese 🙂💔 ja balo takis mone rakis amgo buila jais na abar deka hobe inshaallah fuck your nani 😁💋 {group}');
            await sock.sendMessage(chatId, { 
