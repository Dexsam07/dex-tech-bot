    ...
    try {
        ...
        if (!action) {
            ...
            await sock.sendMessage(chatId, {
                text: `🎭 *AUTO-REACT SETTINGS*\n\n` +
                      ...
                      `━━━━━━━━━━━━━━━━━━━━\n` +
                      `💡 *Examples:*\n` +
                      `└ .areact include add 91846461843787\n` +
                      `└ .areact include add 91846461843787\n` +
        ...
        if (action === 'on') {
            ...
            if (sub === 'add') {
                ...
                if (numbers.length === 0) {
                    await sock.sendMessage(chatId, {
                        text: `⚠️ *USAGE*\n\n━━━━━━━━━━━━━━━━━━━━\n📖 .areact include add <numbers>\n\n✨ *Single:* .areact include add 91846461843787\n✨ *Bulk:* .areact include add 91846461843787,2349012345678\n\n⚠️ Full number with country code is required`,
                        ...channelInfo
                    });
                    return;
                }
            ...
            if (sub === 'add') {
                ...
                if (numbers.length === 0) {
                    await sock.sendMessage(chatId, {
                        text: `⚠️ *USAGE*\n\n━━━━━━━━━━━━━━━━━━━━\n📖 .areact exclude add <numbers>\n\n✨ *Single:* .areact exclude add 91846461843787\n✨ *Bulk:* .areact exclude add 91846461843787,2349012345678\n\n⚠️ Full number with country code is required`,
                        ...channelInfo
                    });
                    return;
                }
